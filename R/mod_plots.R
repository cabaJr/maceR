...
mod_plots_ui <- function(id){
  ...
  tagList(
    ...
    tabsetPanel(id = "plot_panels",
      tabPanel(title = "Actogram", #id = ns("Actogram"),
               fluidRow(
                 shiny::br(),
                 uiOutput(ns("DPacto1")),
                 uiOutput(ns("DPacto2")),
      ...
      tabPanel(title = "Single line actogram", #id = ns("Single line actogram"),
               fluidRow(
                 shiny::br(),
                 uiOutput(ns("acto1")),
                 uiOutput(ns("acto2")),
      ...
      tabPanel(title = "Daily activity",# id = ns("Daily activity"),
               fluidRow(
                 shiny::br(),
                 uiOutput(ns("DAct1")),
                 uiOutput(ns("DAct2")),
      ...
      tabPanel(title = "Periodogram",# id = ns("Periodogram"),
               fluidRow(
                 shiny::br(),
                 uiOutput(ns("Per1")),
                 uiOutput(ns("Per2")),
      ...
      tabPanel(title = "Period boxplots",
               fluidRow(
                 shiny::br(),
      ...
      tabPanel(title = "Average day",# id = ns("Average day"),
               fluidRow(
                 shiny::br(),
                 uiOutput(ns("AvgDay1")),
                 uiOutput(ns("AvgDay2")),
